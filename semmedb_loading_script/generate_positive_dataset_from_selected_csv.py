...
#This script use to generate positive dataset from SENTENCE.csv and positive spo tripples.

if __name__ == "__main__":
    filtered_csv = "./extension_predicate_class.csv.filtered_pmid.csv.selected_relation.csv"
    ...
    #combine spo tripples and sentence
        ...
        while Line:
            ...
            if sents_id in sents_dict:
                for s_name,o_name,s_cui,o_cui in zip(sents_dict[sents_id]["s"],sents_dict[sents_id]["o"],\
                    ...
                    #require subject and object must in sentence
                    ...
                    if s_idx!=-1 and o_idx!=-1:
                        ...
                        #count spo tripples number for subsequent dataset generation
