# -*- coding:utf-8 -*-
#extract gene ontology information from CHEBI.owl
...
#some information transformation
def dict_setttings():
...
#id pattern
def pattern_match():
	pattern = regex.compile("http://purl.obolibrary.org/obo/CHEBI_[0-9]*")
	return pattern
#rdflib settings
...
if __name__ == "__main__":
	...
	#parsing rdflib object and extract information
