...
if __name__ == "__main__":
	...
	#delete constraint
	#graph.schema.drop_uniqueness_constraint("Molecular function", "id")
	try:
		graph.schema.create_uniqueness_constraint("Molecular function", "id")
	except:
		pass
